...
{
    [Authorize(Lazy.Abp.Permissions.IdentityPermissions.IdentityClaimType.Default)]
    public class IdentityClaimTypeAppService : IdentityAppServiceBase, IIdentityClaimTypeAppService
    {
        ...
        [Authorize(Lazy.Abp.Permissions.IdentityPermissions.IdentityClaimType.Create)]
        ...
        [Authorize(Lazy.Abp.Permissions.IdentityPermissions.IdentityClaimType.Delete)]
        ...
        [Authorize(Lazy.Abp.Permissions.IdentityPermissions.IdentityClaimType.Update)]
