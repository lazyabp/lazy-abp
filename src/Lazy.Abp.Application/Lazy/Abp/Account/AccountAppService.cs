...
using Lazy.Abp.Identity.Security;
using Lazy.Abp.Identity.Settings;
...
using IIdentityUserRepository = Lazy.Abp.Identity.IIdentityUserRepository;
...
namespace Lazy.Abp.Account
{
    public class AccountAppService : ApplicationService, IAccountAppService
    {
        ...
        protected virtual async Task<Volo.Abp.Identity.IdentityUser> GetUserByPhoneNumberAsync(string phoneNumber, bool isConfirmed = true)
        {
